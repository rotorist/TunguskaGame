...
////// Specular:
                ...
                finalColor += specular;
                finalColor += emissive;
                float2 node_3941 = i.uv0;
/// Final Color:
                return fixed4(finalColor,tex2D(_MASK,TRANSFORM_TEX(node_3941.rg, _MASK)).r);
            }
            ENDCG
        }
        Pass {
...
////// Specular:
                ...
                finalColor += diffuseLight * lerp((node_3760_if_leA*node_2.rgb)+(node_3760_if_leB*((node_3677*node_3677*_DetailPower)*node_2.rgb)),node_2.rgb,node_3760_if_leA*node_3760_if_leB);
                finalColor += specular;
                float2 node_3942 = i.uv0;
/// Final Color:
                return fixed4(finalColor * tex2D(_MASK,TRANSFORM_TEX(node_3942.rg, _MASK)).r,0);
            }
            ENDCG
        }
    }
