...
public class ActionInvestigate: GoapAction 
{
	private bool _hasStarted;
	private bool _willInvestigate;

	public ActionInvestigate(string name, string description, float cost)
	{
		Name = name;
	...
	{
		CsDebug.Inst.CharLog(ParentCharacter, "Start executing Investigate " + ParentCharacter.name);
